...
func GetWallet(ctx context.Context, adID int64) (*GetWalletRespData, error) {
	params := map[string]interface{}{
		"advertiser_id": adID,
	}
	var resp GetWalletRespData
	err := httpclient.NewClient().AdGet(ctx, adID, "https://ad.oceanengine.com/open_api/v1.0/qianchuan/finance/wallet/get/", &resp, params)
	if err != nil {
